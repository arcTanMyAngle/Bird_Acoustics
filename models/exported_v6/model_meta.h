...
#define MODEL_OUTPUT_SCALE  1.265027970e-01f
#define MODEL_OUTPUT_ZP     9

// --- decision rule: p = softmax(logits/T); detect iff
//     argmax != BACKGROUND_IDX && p[argmax] >= DETECT_TAU_PER_CLASS[argmax] ---
#define DETECT_TEMPERATURE  0.758730f
#define DETECT_TAU          0.810000f  // global fallback / legacy
...
static const float DETECT_TAU_PER_CLASS[N_CLASSES] = {
    0.810000f,  // american_crow
    0.950000f,  // background
    0.810000f,  // california_quail
    0.810000f,  // california_scrub_jay
    0.810000f,  // great_horned_owl
    0.810000f,  // killdeer
    0.810000f,  // mourning_dove
    0.810000f,  // red_tailed_hawk
    0.810000f,  // western_meadowlark
};
